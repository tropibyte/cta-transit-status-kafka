...
# The Faust changelog topic carrying TransformedStation records (plain JSON).
STATIONS_TABLE_TOPIC = "org.chicago.cta.stations.table.v1"

# Per-station arrival topics produced by `producers/models/station.py` (Avro).
ARRIVALS_TOPIC_PREFIX = "org.chicago.cta.station.arrivals."

# KSQL's rolled-up turnstile counts (JSON, uppercased column names).
...
class Line:
    ...
    def process_message(self, message):
        ...
        elif topic.startswith(ARRIVALS_TOPIC_PREFIX):
